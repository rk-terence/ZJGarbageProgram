...
def route_local_search(iterations):
    ...
    for i1 in range(iterations):
        ...
        if global_path_list is None or global_students_dict is None:
            i1 -= 1  # search of this round is neglected - only valuable searches are counted.
            continue
...
if __name__ == '__main__':
    ...
    plt.savefig('my1-stops.png')

    plot_student_potential_assignments(student_near_stops)

    plt.savefig('my1-potential-stops.png')
